    ...
    <Router>
      <div id="app-container">
        ...
        <Switch>
          ...
          <Route exact path="/languages" render={(props2) => props.language_errors ? (<LanguageForm {...props} {...props2} />) : (<Languages {...props} {...props2} />)} />
          <Route exact path="/languages/new" render={(props2) => <LanguageForm {...props} {...props2} />} />
          <Route exact path="/languages/:language_id" render={(props2) => props.language_errors ? (<LanguageForm {...props} {...props2} />) : (<Languages {...props} {...props2} />)} />
          <Route exact path="/languages/:language_id/edit" render={(props2) => <LanguageForm {...props} {...props2} />} />
          
          <Route exact path="/presentations" render={(props2) => props.presentation_errors ? (<PresentationForm {...props} {...props2} />) : (<Presentations {...props} {...props2} />) } />
          <Route exact path="/presentations/new" render={(props2) => <PresentationForm {...props} {...props2} />} />
          <Route exact path="/presentations/:presentation_id" render={(props2) => props.presentation_errors ? (<PresentationForm {...props} {...props2} />) : (<Presentations {...props} {...props2} />) } />
          <Route exact path="/presentations/:presentation_id/edit" render={(props2) => <PresentationForm {...props} {...props2}/>} />          
...
document.addEventListener('turbolinks:load', () => {
  ...
  const presentation_errors = document.getElementById('presentation_errors') && JSON.parse(document.getElementById('presentation_errors').getAttribute('data')).length > 0 ?
                              JSON.parse(document.getElementById('presentation_errors').getAttribute('data')) : null;
  const language_errors = document.getElementById('language_errors') && JSON.parse(document.getElementById('language_errors').getAttribute('data')).length > 0 ?
