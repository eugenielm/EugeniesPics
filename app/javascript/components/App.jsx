            ...
            return (
                  ...
                  <Switch>
                        ...
                        <Route exact path="/categories/:category_id/cat_descriptions" 
                               render={(props2) => this.props.cat_description_errors ? 
                        ...
                        <Route exact path="/languages" 
                               render={(props2) => this.props.language_errors ? 
                        ...
                        <Route exact path="/presentations" 
                               render={(props2) => this.props.presentation_errors ? 
                        ...
                        <Route exact path="/users" 
                               render={(props2) => this.props.user_errors ? 
